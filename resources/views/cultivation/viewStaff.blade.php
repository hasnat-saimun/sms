            ...
            <div class="card-body">
                ...
                <table class=" table   rounded" >
                    <tbody class="">
                        <th class="mx-auto">
                            <td>
                            <img class="" style="width:150px;height:150px;" src="{{ asset('/public/upload/image/staff/') }}/{{$singleData->avatar}}" alt="$singleData->firstName">
                            </td>
                        </th>
                        <tr>
                            <th>ID</th>
                            <td>{{$singleData->staffId}}</td>
                        </tr>
                        <tr>
                            <th>Designation</th>
                ...
                <div class="mt-3">
                    <a href="{{route('staffList')}}"class="btn-fill-lg bg-blue-dark btn-hover-bluedark">Back</a>
