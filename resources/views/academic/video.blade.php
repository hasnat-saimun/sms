        ...
        <table id="myTable" class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->avatar }}</td>
                    <td>
                        <a href="{{ route('editVideo',['id'=>$item->id]) }}"><i class="fa-light fa-pen-to-square fa-xl"></i></a>
                        <a href="{{ route('delVideo',['id'=>$item->id]) }}" onclick="return confirm('Are you sure to delete?')"><i class="fa-thin fa-circle-trash fa-xl"></i></a>
                    </td>
                </tr>
                @endforeach @else
                <tr>
