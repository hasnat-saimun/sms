                    ...
                    <div class="col-12">
                        <div class="row" id="idCard-{{ $std->id }}">
                            ...
                            <div class="col-12 row mb-4">
                                ...
                                <div class="col-12 row align-items-center" style="margin:2rem 0">
                                    <div class="col-2">
                                        @if(!empty($std->avatar))
                                ...
                                <div class="col-12 table-responsive" style="margin:2rem 0">
                                ...
                                <div class="col-12 row" style="margin:4rem 0">
                                    <div class="col-6">
